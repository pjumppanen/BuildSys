...
will be the same as the state of the parent \strong{R} session when \code{vcDebug(Project)} was called. This behaviour is implemented as a aid to debugging as most 
...
configuring the necessary files to support debugging and constructing a suitable debug build can present to successfully debugging dynamic libraries for \strong{R}.
